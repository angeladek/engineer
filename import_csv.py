...
# Open file
# os.chdir('C:/Temp')
csv_file = open('Data practicum Engineer 1\meteo_stations.csv')
...
for lijn in csv_file :
    ...
    if lijn_nummer > 0 :
        ...
        insert_stmt = 'insert into meteostation ( meteostationid, hoogte, name, location ) values ( %s, %s, %s, ST_Transform(ST_SetSRID(ST_MakePoint(%s,%s),4326),28992))' 
        cur.execute ( insert_stmt, ( meteostationid, hoogte, name, lon, lat ) )
